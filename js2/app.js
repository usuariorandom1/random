...
try {
    ...
    tronWeb = new TronWeb(metacoinConfig.fullHost, metacoinConfig.fullHost, metacoinConfig.fullHost, metacoinConfig.privateKey)
} catch (err) {
...
(function() {
    window.addEventListener('message', ({
        ...
        if (!window.tronLinkInitialData && isTronLink && message.action === 'tabReply') {
            window.tronLinkInitialData = message.data.data;
        }
    });
})();
...
App = {
    ...
    init: async function() {
        ...
        let address = await tronWeb.defaultAddress.base58;
